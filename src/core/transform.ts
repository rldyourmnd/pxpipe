...
const DEFAULTS: Required<TransformOptions> = {
  ...
  // 312 cols × 5 px + 8 px pad = 1568 px slab width — matches render.ts
  // DEFAULT_COLS / MAX_WIDTH_PX exactly (313 → 1573 px overshot the 1568 cap,
  // forcing a 0.997× resample).
  cols: 312,
